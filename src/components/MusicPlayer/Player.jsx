...
const Player = (props) => {
  ...
  useEffect(() => {
    ...
    audioEl.current.onloadeddata = () => {
      if (audioEl.current != null) setDurationTime(audioEl.current.duration)
    }
    setInterval(() => {
      if (audioEl.current !== null) setCurrTime(audioEl.current.currentTime)
    })
  })
  useEffect(() => {
